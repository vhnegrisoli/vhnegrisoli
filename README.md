...
Sou graduado em Ciência da Computação pelo 👨‍💻 Centro Universitário Filadélfia (UniFil).

Atualmente estou cursando uma pós-graduação em Ciência de Dados & Big Data pela 👨‍💻 Pontifícia Universidade Católica de Minas Gerais (PUC-MG). 

Meu sonho e objetivo é me tornar um excelente desenvolvedor back-end de diversos tipos de aplicações e aplicar conceitos de estatística, análise e visualização de dados nos projetos, assim como práticas de Machine Learning.
